...
public class UserInfoVo implements Serializable {
     ...
     */
    @JsonSerialize(nullsUsing = NullStringSerializer.class)
    @Schema(description = "Email", example = "aduser@example.com")
     ...
     */
    @Schema(description = "System role: user=regular user, admin=system admin",
        example = "user")
    private String role;
     ...
     */
    @Schema(description = "Whether the user has modified "
        + "the nickname")
     ...
     */
    @Schema(description = "Whether the member has modified"
        + " the nickname")
    ...
    public void transferDataFromLoginUserDto(final LoginUserDto loginUserDto) {
        ...
        this.setRole(loginUserDto.getRole());
