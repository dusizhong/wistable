...
public class LoginRo {
    ...
    @Schema(description = "Login Name", example = "13829291111 ｜ user@example.com",
    ...
    @Schema(description = "Login Type, fixed value, only password（Password）、sms_code（SMS "
        + "verification）、email_code（Email verification code）、sso_auth can be input", example = "password",
        requiredMode = RequiredMode.REQUIRED)
