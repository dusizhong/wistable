...
public interface SpaceMapper extends BaseMapper<SpaceEntity> {
    ...
    /**
     * admin: paginated space list with keyword search.
     *
     * @param page    page object
     * @param keyword search keyword (space name or space id)
     * @return IPage of AdminSpaceVo
     */
    IPage<AdminSpaceVo> selectAdminSpacePage(Page<AdminSpaceVo> page, @Param("keyword") String keyword);
}
