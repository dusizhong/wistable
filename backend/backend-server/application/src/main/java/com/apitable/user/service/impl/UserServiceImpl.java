...
public class UserServiceImpl extends ServiceImpl<UserMapper, UserEntity>
    ...
    @Override
    public void verifyOldPassword(final Long userId, final String oldPassword) {
        log.info("Verify Old Password");
        UserEntity user = getById(userId);
        ExceptionUtil.isTrue(user != null, USER_NOT_EXIST);
        boolean matches = passwordService.matches(oldPassword, user.getPassword());
        ExceptionUtil.isTrue(matches, USERNAME_OR_PASSWORD_ERROR);
    }
    ...
    public UserInfoVo getCurrentUserInfo(final Long userId,
        ...
        if (StrUtil.isBlank(userInfo.getRole())) {
            userInfo.setRole(getById(userId).getRole());
        }
