...
public interface UserMapper extends BaseMapper<UserEntity> {
    ...
    /**
     * admin: paginated user list with keyword search.
     *
     * @param page    page object
     * @param keyword search keyword (nickname/email/mobile)
     * @return IPage of UserAdminVo
     */
    IPage<UserAdminVo> selectUserPage(Page<UserAdminVo> page, @Param("keyword") String keyword);
}
