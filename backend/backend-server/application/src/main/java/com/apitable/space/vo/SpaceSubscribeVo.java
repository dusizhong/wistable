...
public class SpaceSubscribeVo {
    ...
    @Schema(description = "whether it has feishu integration", example = "false")
    @JsonSerialize(nullsUsing = NullBooleanSerializer.class)
    private Boolean integrationFeishu;

    @Schema(description = "whether it has dingtalk integration", example = "false")
    @JsonSerialize(nullsUsing = NullBooleanSerializer.class)
    private Boolean integrationDingtalk;

    @Schema(description = "whether it has wecom integration", example = "false")
    @JsonSerialize(nullsUsing = NullBooleanSerializer.class)
    private Boolean integrationWeCom;

    @Schema(description = "whether it has office preview integration", example = "false")
    @JsonSerialize(nullsUsing = NullBooleanSerializer.class)
