...
public class WidgetReleaseListVo {
    ...
    @Schema(description = "Code Address", example = "https://example.com/code/placeholder")
    @JsonSerialize(using = ImageSerializer.class)
    private String releaseCodeBundle;

    @Schema(description = "Source code address", example = "https://example.com/code/placeholder")
    @JsonSerialize(using = ImageSerializer.class)
