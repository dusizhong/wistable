/**
 * 管理员配置空间用量限额的请求对象。所有字段可选，值为 null 时使用系统默认限额。
 *
 * @author  系统管理员
 * @created 2026-07-27
 */
...
@Data
@Schema(description = "Space Capacity Config Request (all fields optional, NULL=use default)")
public class SpaceCapacityConfigRo {

    @Schema(description = "Max members")
