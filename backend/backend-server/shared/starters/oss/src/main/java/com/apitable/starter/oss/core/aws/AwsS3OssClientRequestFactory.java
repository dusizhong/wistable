...
public class AwsS3OssClientRequestFactory implements OssClientRequestFactory {
    ...
    public AwsS3OssClientRequestFactory(AWSCredentials credentials,
            EndpointConfiguration configuration) {
        this(credentials, configuration, null);
    }

    public AwsS3OssClientRequestFactory(AWSCredentials credentials,
            EndpointConfiguration configuration, String bucketPolicyJson) {
    ...
    public OssClientRequest createClient() {
        AmazonS3 s3Client =
                AmazonS3ClientBuilder.standard()
                        ...
                        .build();
        return new AwsOssClientRequest(s3Client, true, bucketPolicyJson);
    }
}
