...
export const theme1 = {
  defaultColor: '#5586FF',
  colors10: ['#5586FF', '#5B8FF9', '#61DDAA', '#65789B', '#F6BD16', '#6F5EF9', '#78D3F8', '#9661BC', '#F6903D', '#F08BB4'],
  colors20: ['#5586FF', '#5B8FF9', '#CDDDFD', '#61DDAA', '#CDF3E4', '#65789B', '#CED4DE', '#F6BD16', '#6F5EF9', '#D3CEFD', '#78D3F8', '#D3EEF9', '#9661BC', '#DECFEA', '#F6903D', '#FFE0C7', '#008685', '#BBDEDE', '#F08BB4', '#FFE0ED'],
};
