...
function MyAppMain({ Component, pageProps, envVars }: AppProps & { envVars: string }) {
  ...
  useEffect(() => {
    ...
    const endLoading = () => {
      ...
      setTimeout(() => setLoading(LoadingStatus.Complete), 400);
    };
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="keywords"
          content="WisTable,datasheet,Airtable,nocode,low-code,aPaaS,hpaPaaS,RAD,web3,多维表格,AI多维表格,大数据,数字化,数字化转型,数据中台,业务中台,数据资产,
