...
import { getAssetUrl, IReduxState, t, Strings } from '@apitable/core';
  ...
  return (
    <div className={styles.mobileHome}>
      <div className={styles.header}>
        ...
        <span className={styles.systemName}>智能表格系统</span>
      </div>
      ...
      <div className={styles.footer}>
        <span className={styles.poweredBy}>Powered by APITable</span>
      </div>
    </div>
  );
};
