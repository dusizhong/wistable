...
import { ConfigConstant, Events, hiddenMobile, IReduxState, isIdassPrivateDeployment, Player, Selectors, Strings, t } from '@apitable/core';
...
export const UserMenu: FC<React.PropsWithChildren<IUserMenuProps>> = (props) => {
  ...
  const { ACCOUNT_LOGOUT_VISIBLE, USER_BIND_PHONE_VISIBLE } = getEnvVariables();
  ...
  const { avatar, avatarColor, nickName, memberId, memberName, spaceName, mobile, email, isMemberNameModified } = userInfo;
