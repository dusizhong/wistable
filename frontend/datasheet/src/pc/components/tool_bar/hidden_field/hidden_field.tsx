...
import { DisabledOutlined, DragOutlined, ImageOutlined, InfoCircleOutlined } from '@apitable/icons';
      ...
      <div className={styles.header}>
        <ComponentDisplay minWidthCompatible={ScreenSize.md}>
          <div className={styles.title}>
            ...
            {[ViewType.Gallery, ViewType.Kanban].includes(activeView.type) && null}
          </div>
