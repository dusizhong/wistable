...
const ToolbarBase = () => {
  ...
  const featureToolItems = [
    ...
    },
    {
      ...
      key: 'foreignForm',
      show: false, // HIDE_FEATURE: 表单按钮 // Original: isGridView && !shareId && !templateId && !mirrorId && embedSetting.formBtn
    },
    {
      component: <MirrorList key="mirror" className={styles.toolbarItem} showLabel={showIconBarLabel} />,
      key: 'mirror',
      show: false, // HIDE_FEATURE: 镜像按钮 // Original: !shareId && !templateId && !mirrorId && (!embedId || (embedId && embedSetting.mirrorBtn))
    },
    {
      component: (
        <ToolItem
      ...
      key: 'api',
      show: false, // HIDE_FEATURE: API按钮 // Original: !isGanttView && !shareId && !templateId && !mirrorId && embedSetting.apiBtn
    },
    {
      component: (
        <ToolItem
      ...
      key: 'widget',
      show: false, // HIDE_FEATURE: 小组件按钮 // Original: !shareId && embedSetting.widgetBtn
    },
    {
      component: (
        <ToolItem
      ...
      key: 'robot',
      show: false, // HIDE_FEATURE: 自动化按钮 // Original: !mirrorId && !shareId && !templateId && embedSetting.robotBtn
    },
    {
      component: (
        <ToolItem
    ...
    },
    {
      ...
      key: 'archivedRecords',
      show: false, // HIDE_FEATURE: 归档箱按钮 // Original: !shareId && !mirrorId && !templateId && permissions.manageable
    },
  ];
