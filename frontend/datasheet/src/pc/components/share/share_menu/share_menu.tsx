      ...
      {!singleFormShare && (
        <>
          {shareSpace.allowSaved && (
            <OperationCard tipText={t(Strings.save_action_desc)} btnText={t(Strings.save_to_space)} onClick={saveToMySpace} />
          )}
          ...
          {shareSpace.allowEdit && !userInfo && !loading && (
            <OperationCard tipText={t(Strings.share_login_tip)} btnText={t(Strings.login)} onClick={handleLogin} />
          )}
