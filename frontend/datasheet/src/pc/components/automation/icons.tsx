...
const LinkIcon: React.FC<IIconProps> = makeIcon({
  Path: ({ colors }) => (
    <>
      <rect x="7.5" width="1" height="20" fill="#81A5FF" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        fill="#81A5FF"
      />
      <rect x="7.5" y="28" width="1" height="20" fill="#81A5FF" />
    </>
  ),
  name: 'link_icon',
...
const AddIcon: React.FC<IIconProps> = makeIcon({
  Path: ({ colors }) => (
    <>
      <rect x="7.5" width="1" height="18" fill="#81A5FF" />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        // eslint-disable-next-line max-len
        ...
        fill="#81A5FF"
      />
      <rect x="7.5" y="30" width="1" height="18" fill="#81A5FF" />
    </>
  ),
  name: 'add_icon',
  defaultColors: ['#D9D9D9'],
