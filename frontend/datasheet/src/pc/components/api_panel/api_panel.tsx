...
import { Checkbox, useThemeColors } from '@apitable/components';
import { ResourceType, Selectors, StoreActions, Strings, t } from '@apitable/core';
import { ApiOutlined, CloseOutlined } from '@apitable/icons';
...
export const ApiPanel: React.FC<React.PropsWithChildren<unknown>> = () => {
  ...
  return (
    <div className={styles.apiPanelContainer}>
      ...
      {showAccountCenter && <AccountCenterModal defaultActiveItem={2} setShowAccountCenter={setShowAccountCenter} />}
    </div>
  );
};
